...
{
   $version = "3.0";
   $keywords = "Turkiball, sport, sports, Guardian Sports, University of Michigan, Michigan, Ann Arbor";
   if ($where == 0)
   ...
   echo "<!-- Favicon link -->\n";
   echo "<link REL=\"SHORTCUT ICON\" HREF=\"http://www.guardiansportsalliance.com/images/favicon.ico\">\n\n";
   echo "<!-- CSS link -->\n";
   echo "<link rel = 'stylesheet' type = \"text/css\" href = \"http://www.guardiansportsalliance.com/style.css\">\n\n";
   echo "<script type=\"text/javascript\" src=\"http://www.guardiansportsalliance.com/scripts/functions.js\"></script>\n\n";
...
function title()
{
   ...
   echo "         <a href = \"http://www.guardiansportsalliance.com/index.php\">\n";
   echo "         <img src = \"http://www.guardiansportsalliance.com/images/titleinv.jpg\" border = \"0\" alt = \"Title\">\n";
   echo "         </a>\n";
   echo "      </div>\n";
   echo "   </div>\n";
}
...
function newsbar($where)
{
   ...
   echo "   <div class = \"news\">\n";
   echo "      <ul class = \"newslink\"><li" . $feed . "><a href = \"http://www.guardiansportsalliance.com/\">GSA</a></ul>\n";
   echo "      <br><br><br>\n";
   echo "      <ul class = \"newslink\"><li" . $league . "><a href = \"http://www.turkiball.com/\">Turkiball</a></ul>\n";
   echo "      <br><br><br>\n";
   echo "      <ul class = \"newslink\"><li" . $board . "><a href = \"http://www.guardiansportsalliance.com/board\">The Board</a></ul>\n";
   echo "      <br><br><br>\n";
